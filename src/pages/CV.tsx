  ...
  return (
    <CVContainer>
      <DownloadSection>
        ...
        <DownloadLink href="/files/CV/Md__Nihad_Hossain_Resume  Backend.pdf" download target="_blank" rel="noopener noreferrer">
          <Download size={18} />
          Download CV
        </DownloadLink>
      </DownloadSection>
        ...
        <object
        data="https://drive.google.com/file/d/1KpAD0xgjdvgWzCNQBz6Jd-HJjo0Qi_LK/preview" 
      ...
      <ContactSection>
        ...
        <SocialSection>
          ...
          <SocialLink href="https://www.linkedin.com/in/md-nihad-h-5568b51a3/" target="_blank" rel="noopener noreferrer">
            <Linkedin size={18} />
            LinkedIn Profile
          </SocialLink>
        </SocialSection>
