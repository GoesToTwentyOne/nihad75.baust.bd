  ...
  return (
    <SidebarContainer>
      <SidebarContent>
        <ProfileSection>
          <ProfilePicture>
            <img src="/images/profile_2.png" alt="Md. Nihad Hossain" />
          </ProfilePicture>
          <Name>Md. Nihad Hossain</Name>
          <Title>Researcher & Junior Backend Engineer </Title>
        </ProfileSection>
        ...
        <ContactInfo>
          ...
          <ContactItem>
            ✉️ <span><a href="mailto:bcc.researcher@baust.edu.bd">bcc.researcher@baust.edu.bd</a></span>
          </ContactItem>
                 <ContactItem>
            ✉️ <span><a href="mailto:hnihadgo75@gmail.com">hnihadgo75@gmail.com</a></span>
          </ContactItem>
        </ContactInfo>
        ...
        <AcademicLinks>
          ...
          <LinkItem href="https://www.researchgate.net/profile/Md-Nihad-Hossain" target="_blank" rel="noopener noreferrer">
          ...
          <LinkItem href="https://www.linkedin.com/in/md-nihad-h-5568b51a3/" target="_blank" rel="noopener noreferrer">
            <LinkIcon><Linkedin size='24'/></LinkIcon>
            LinkedIn
          </LinkItem>
          <LinkItem href="https://github.com/GoesToTwentyOne" target="_blank" rel="noopener noreferrer">
